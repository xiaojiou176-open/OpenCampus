...
const TEXT: Record<ResolvedUiLanguage, UiText> = {
  en: {
    ...
    providerReasons: {
      ...
      configuredLocalRuntime: 'local route ready',
      missingApiKey: 'missing API key',
      missingRuntimeUrl: 'missing local route URL',
    },
    ...
    todaySnapshot: {
      title: 'At a glance',
      description: 'A quick desk check before you go deeper.',
    ...
    quickActions: {
      title: 'Quick moves',
      description: 'Keep the next few actions close at hand.',
    ...
    planningPulse: {
      ...
      description:
        'The latest planning snapshot stays visible here, so term load, backups, and planning gaps stay readable without implying registration automation.',
    ...
    groupedView: {
      title: 'Two reading lanes',
      heading: 'One desk, two ways to read it',
      description:
        'The same decision desk separates academic work from administrative signals without turning them into two different products.',
    ...
    diagnostics: {
      title: 'System check',
      description: 'Open this only when the desk looks wrong or needs a closer review.',
      nextActions: 'Next Actions',
      readyToContinue: 'Ready to review',
    ...
    priorityAlerts: {
      ...
      description: 'This keeps the most urgent work visible first, so you can act on what needs attention now.',
      low: 'Low',
      critical: 'Critical',
      high: 'High',
      medium: 'Medium',
    ...
    recentUpdates: {
      ...
      description: 'This keeps the latest changes visible without pulling you away from the current desk.',
    ...
    siteStatus: {
      title: 'Site Status',
      description: 'This area tells the truth about desk state: which site is ready, which is partial, and which one is blocked by context or setup.',
      trustStates: {
        fresh: 'fresh',
        partial: 'partial',
        stale: 'stale',
    ...
    askAi: {
      ...
      advancedRuntimeDescription:
        'Provider, model, and Switchyard controls stay here as AI-route details. The workspace should stay the main character on the first screen.',
    ...
    feedback: {
      ...
      noDisplayableAnswer: 'The local AI service responded, but the current provider did not return a displayable answer.',
    ...
    diagnosticsMessages: {
      ...
      nextActionRefreshProviderStatus: 'Confirm that the local AI service is running, then refresh route status.',
    },
    blockingHints: {
  ...
  'zh-CN': {
    ...
    providerReasons: {
      unknown: '未知',
      configured: '已配置',
      configuredLocalRuntime: '本地 AI 路线已就绪',
      missingApiKey: '缺少 API key',
      missingRuntimeUrl: '缺少本地路线地址',
    },
    priorityReasonLabels: {
      due_soon: '即将到期',
      overdue: '已逾期',
    ...
    diagnosticsMessages: {
      ...
      nextActionRefreshProviderStatus: '确认本地 AI 服务正在运行，随后点击“刷新 AI 路线状态”。',
    },
    blockingHints: {

...
- If Ask AI, empty-state routing, or first-screen trust wording changes materially, refresh the Ask AI proof asset in the same wave as README/docs copy.
- If a video still or walkthrough is part of the outward-facing story, it must also be listed here with an owner, a purpose, and an update rule instead of living as an orphan asset.

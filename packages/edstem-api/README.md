...
Read-only EdStem helpers over the current Campus Copilot snapshot contract.
...
- `buildEdStemSnapshotView(snapshot, limit?)`

## Minimal usage

See [`../../examples/edstem-api-usage.ts`](../../examples/edstem-api-usage.ts).

## Boundary

- public-ready repo-local packaging over the shared snapshot contract
- not an official EdStem public API claim
...
- [`../../examples/edstem-api-usage.ts`](../../examples/edstem-api-usage.ts)

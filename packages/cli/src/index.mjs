...
function renderHelp() {
  return [
    ...
    '  snapshot-summary <path> [--site <canvas|gradescope|edstem|myuw>]',
    '  site --snapshot <path> --site <canvas|gradescope|edstem|myuw>',
    '  site-summary <path> --site <canvas|gradescope|edstem|myuw>',
    '  snapshot site --snapshot <path> --site <canvas|gradescope|edstem|myuw>',
